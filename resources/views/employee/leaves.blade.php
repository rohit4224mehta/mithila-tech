    ...
    <div class="min-h-screen bg-gradient-to-br from-indigo-900 via-blue-600 to-purple-600">
        <section class="py-20 text-center">
            <div class="container mx-auto px-4">
                <h1 class="text-4xl md:text-5xl font-extrabold text-white mb-6 animate__animated animate__fadeInDown">Leave Requests</h1>
                <p class="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto mb-10 animate__animated animate__fadeInUp">
                    This section will allow you to submit and track leave requests.
                </p>
            </div>
        </section>
        ...
        <section class="py-16 bg-white/95 backdrop-blur-lg">
            <div class="container mx-auto px-4 text-center">
                <p class="text-gray-600">Placeholder for leave request details. To be expanded later.</p>
            </div>
        </section>
