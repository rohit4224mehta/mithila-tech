    ...
    <div class="min-h-screen bg-gradient-to-br from-indigo-900 via-blue-600 to-purple-600">
        <section class="py-20 text-center">
            <div class="container mx-auto px-4">
                <h1 class="text-5xl font-extrabold text-white mb-6 animate__animated animate__fadeInDown">Cloud Managed Services</h1>
                <p class="text-xl text-gray-200 max-w-3xl mx-auto mb-10 animate__animated animate__fadeInUp">
                    Scalable cloud solutions to drive your business forward with flexibility and security.
                </p>
            </div>
        </section>
            ...
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div class="animate__animated animate__fadeInLeft">
                        <h2 class="text-3xl font-bold text-gray-800 mb-4">Our Cloud Expertise</h2>
                        <p class="text-gray-600 leading-relaxed">
                            We offer cloud migration, management, and optimization services, ensuring your data is secure and accessible. Our solutions are designed to scale with your business, providing cost-effective and reliable infrastructure.
                        </p>
                    </div>
                    <div>
                        <img src="https://via.placeholder.com/600x400?text=Cloud+Services" alt="Cloud Services" class="rounded-xl shadow-2xl w-full h-auto hover:scale-105 transition-transform duration-300">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container mx-auto px-4 text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="p-6 bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300">
                        <i class="bi bi-lock-fill text-4xl text-indigo-600 mb-4"></i>
                        <h3 class="text-xl font-semibold text-gray-800">Data Security</h3>
                        <p class="text-gray-600">Robust encryption and compliance with global standards.</p>
                    </div>
                    <div class="p-6 bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300">
                        <i class="bi bi-arrow-up-circle-fill text-4xl text-indigo-600 mb-4"></i>
                        <h3 class="text-xl font-semibold text-gray-800">Scalability</h3>
                        <p class="text-gray-600">Easily scale resources to match your growth.</p>
                    </div>
                    <div class="p-6 bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300">
                        <i class="bi bi-speedometer2 text-4xl text-indigo-600 mb-4"></i>
                        <h3 class="text-xl font-semibold text-gray-800">Performance</h3>
                        <p class="text-gray-600">Optimized cloud performance for your applications.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-16 bg-white/95 backdrop-blur-lg">
            <div class="container mx-auto px-4 text-center">
                ...
                <div class="max-w-2xl mx-auto bg-indigo-50 p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300">
                    <p class="text-gray-600 italic mb-4">"Volera’s cloud migration was seamless and saved us 30% on costs!"</p>
                    <p class="text-gray-800 font-semibold">- Global Retail CIO</p>
                </div>
            </div>
        </section>
        ...
        <section class="py-20 text-center bg-gradient-to-br from-indigo-900 to-blue-600">
            <div class="container mx-auto px-4">
                ...
                <p class="text-lg text-gray-200 max-w-2xl mx-auto mb-8 animate__animated animate__fadeInUp">
                    Transform your cloud infrastructure with our expertise. Reach out now!
                </p>
